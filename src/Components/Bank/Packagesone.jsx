...
<div className='flex justify-center'>
    ...
    <div className='flex flex-col w-[72%] justify-center'>
        ...
        <div className='flex items-center justify-center px-2 w-full text-2xl mt-14 arabic text-[#0092A0] mb-2'>
            اسم الصفحة <span className='font-bold mr-1'>(  باقات الإعلانات  )</span>
        </div>
            ...
            <div className='h-[45px] mt-[2rem] justify-center rounded-t-sm shadow-[rgba(0,_0,_0,_0.2)_0px_2px_5px]'>
                <div className='flex w-full mt-2.5 justify-center'>
                    <div className='flex arabic justify-center'>
                        <p className='text-md font-bold text-right mb-2 text-[#494949]'>هل تريد أن يبرز إعلانك أكثر؟ اختر واحدة من باقاتنا</p>
                    </div>
                </div>
            </div>

            <div className='bg-[#0092A0] h-[50px] mt-20 justify-end rounded-t-sm'>
                <div className='flex w-full mt-2.5 justify-end'>
                    <div className='flex arabic justify-end mr-6'>
                        <img className='relative w-[30px] ml-1' src={pricew} alt="pricew" />
                        <p className=' text-xl font-bold mr-3 text-white text-right'>أنواع الباقات الإعلاانية</p>
                    </div>
                </div>
            </div>

            <div className='w-full mb-10 bg-white flex flex-col justify-center h-[70rem] sm:h-[65rem] md:h-[45rem] xl:h-[27rem]
             rounded-b-sm object-cover shadow-[rgba(0,_0,_0,_0.2)_0px_2px_5px]'>
                <div className="flex flex-wrap justify-center items-center gap-20 xl:flex-nowrap">
                    ...
                    className=' w-[15.5rem] cursor-pointer  pt-6 rounded-t-md flex flex-col justify-center arabic border-[#0092A0] border-[1px]
                    ...
                    <div
                        ...
                        className='bg-[#2F2851] py-2 items-center flex justify-center'>
                    ...
                    className='cursor-pointer w-[15.5rem]  pt-6  rounded-t-md flex flex-col justify-center arabic border-[#448CCB] border-[1px]
                    hover:shadow-2xl ease-linear transition-all duration-150 hover:scale-105
                    '>
                    ...
                    onClick={(e) => {
                        ...
                        className='cursor-pointer w-[15.5rem]  pt-6 rounded-t-md flex flex-col justify-center arabic border-[#3CB878] border-[1px]
                    hover:shadow-2xl ease-linear transition-all duration-150 hover:scale-105
                    '>
