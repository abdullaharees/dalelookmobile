    ...
    <div>
      <div onClick={() => setNav(!nav)} 
              ...
              {(nav || filterActive === 'item3') ? <div 
                    ...
                    <div className={(nav || filterActive === 'item3') ? 'fixed top-3 right-0 w-[80%] h-screen bg-white z-[10003] duration-300' : 'fixed top-3 right-[-100%] w-[350px] h-screen bg-white z-10 duration-300'}>
