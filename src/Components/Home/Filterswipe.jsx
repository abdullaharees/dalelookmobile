    ...
    <div>
      <div onClick={() => setNav(!nav)} 
              ...
              <div className='arabic'>
                ...
                <div className=' flex justify-between'>
                  <div className='border-r-[2.5px] border-[#0092A0] h-[1.9rem] mr-[0.35rem]'></div>
                  <p className='text-sm mt-1 ml-[6.5rem]'>المدينة</p>
                  <div className='flex'>
                    <p className='text-[0.65rem] mt-2'>12.358 إعلان</p>
                    <MdKeyboardArrowLeft className='text-[#333333] mt-2' size={15}/>
                  </div>
                ...
                <div className=' flex justify-between'>
                  <div className='border-r-[2.5px] border-[#0092A0] h-[1.9rem] mr-[0.35rem]'></div>
                  <p className='text-sm mt-1 ml-[6.5rem]'>الماركة</p>
                  <div className='flex'>
                    <p className='text-[0.65rem] mt-2'>12.358 إعلان</p>
                    <MdKeyboardArrowLeft className='text-[#333333] mt-2' size={15}/>
                  </div>
                ...
                <div className=' flex justify-between'>
                  <div className='border-r-[2.5px] border-[#0092A0] h-[1.9rem] mr-[0.35rem]'></div>
                  <p className='text-sm mt-1 ml-[6.5rem]'>السعر</p>
                  <div className='flex'>
                    <p className='text-[0.65rem] mt-2'>12.358 إعلان</p>
                    <MdKeyboardArrowLeft className='text-[#333333] mt-2' size={15}/>
                  </div>
                ...
                <div className=' flex justify-between'>
                  <div className='border-r-[2.5px] border-[#0092A0] h-[1.9rem] mr-[0.35rem]'></div>
                  <p className='text-sm mt-1 ml-[4.5rem]'>سنة التصنيع</p>
                  <div className='flex'>
                    <p className='text-[0.65rem] mt-2'>12.358 إعلان</p>
                    <MdKeyboardArrowLeft className='text-[#333333] mt-2' size={15}/>
                  </div>
                ...
                <div className=' flex justify-between'>
                  <div className='border-r-[2.5px] border-[#0092A0] h-[1.9rem] mr-[0.35rem]'></div>
                  <p className='text-sm mt-1 ml-[6.5rem]'>الناقل</p>
                  <div className='flex'>
                    <p className='text-[0.65rem] mt-2'>12.358 إعلان</p>
                    <MdKeyboardArrowLeft className='text-[#333333] mt-2' size={15}/>
                  </div>
                ...
                <div className=' flex justify-between'>
                  <div className='border-r-[2.5px] border-[#0092A0] h-[1.9rem] mr-[0.35rem]'></div>
                  <p className='text-sm mt-1 ml-[6.5rem]'>الوقود</p>
                  <div className='flex'>
                    <p className='text-[0.65rem] mt-2'>12.358 إعلان</p>
                    <MdKeyboardArrowLeft className='text-[#333333] mt-2' size={15}/>
                  </div>
                ...
                <div onClick={() => setNav(!nav)}  className='bottom-0 flex justify-center mt-[10rem]'>
