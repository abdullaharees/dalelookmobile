...
const Filterswipe = ({setFilterActive}) => {
const [nav, setNav] = useState(false)
  return (
    <div>
      <div onClick={() => setNav(!nav)} 
              className='flex flex-col justify-center items-center mt-0.5 mr-[2rem] ml-[2.5rem]'>
              ...
              <div className={nav ? 'flex flex-col fixed top-0 right-0 w-[19rem] h-full bg-white z-[10003] duration-300' : 'fixed top-0 right-[-100%] w-[350px] h-screen bg-white z-10 duration-300'}>
              ...
              <div className='arabic'>
                ...
                <div className=' flex justify-between' onClick={e => setFilterActive('item2')}>
