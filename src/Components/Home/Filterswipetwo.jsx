  ...
  return (
    <div>
      <div onClick={() => setNav(!nav)} 
              ...
              <div className={(nav || filterActive === 'item2') ? 'fixed top-3 right-0 w-[80%] max-w-[19rem] h-screen bg-white z-[10003] duration-300' : 'fixed top-3 right-[-100%] h-screen bg-white z-10 duration-300'}>
