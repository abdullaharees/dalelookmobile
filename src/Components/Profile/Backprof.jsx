  ...
  return (
    <div className='bg-[#0092A0] h-[2.6rem] flex justify-between'>
        <div className='flex justify-between'>
            ...
            <div className='z-10 mt-3.5 flex pl-[3rem]'>
            ...
            <div>
                <button className='cursor-pointer bg-[white] w-[3.5rem] h-[23px] ml-[3.5rem] mt-3 rounded-md flex justify-center items-center arabic'>
